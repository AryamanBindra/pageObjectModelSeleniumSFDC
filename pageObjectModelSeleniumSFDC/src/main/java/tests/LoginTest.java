...
public class LoginTest extends TestBase {
	...
	public void TC01(String username, String pass) throws IOException {
		...
		Assert.assertTrue(Utilities.assertEquals(lp.enterPassErrorMsg.getText(), "Please enter your password."),
...
//			test.addScreenCaptureFromPath(Utilities.captureScreenshot(driver));
	...
	public void TC03(String username, String pass) throws IOException {
		...
		Assert.assertTrue(Utilities.assertEquals(Utilities.getText(driver, lp.savedUsername), "jul22.aryaman@ta.com"),
				"Username not Saved");
